...
# The line below creates a sequence of years from 0 to 8 by 1 (look at 8 year time frame)
time_yr <- seq(from = 0, to = 8, by = 1)

time_yr

# The line below creates an empty matrix with appropriate rows and lengths for initial fish pop and time
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below fills proj_year with our initial data but by starting to fill it at row 1
proj_year[1, ] <- fish_year0


# The for loop below start filling in row 2 with a length of time_year and loop that through each column by dot product of fish_leslie * proj_year. 
